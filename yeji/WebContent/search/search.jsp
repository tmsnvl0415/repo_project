...
<% 
	...
	//String check = "notchecked";
	String check = request.getParameter("check");
	String price = request.getParameter("price");
	String detail = request.getParameter("detailgroup");
	...
	if(check!=null) {
		if(detail.equals("publisher"))
			sql ="select * from 책 where 출판사 like ?";
		else if(detail.equals("writer"))
			sql ="select * from 책 where 저자 like ?";
		else
			sql ="select * from 책 where 책이름 like ?";
	}
	else
	{
		sql ="select * from 책 where 책이름 like ? or 저자 like ? or 출판사 like ?";
	}
